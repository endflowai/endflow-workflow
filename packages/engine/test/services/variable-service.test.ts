...
describe('Variable Service', () => {
  test('Test resolve inside nested loops', async () => {
    ...
    const { resolvedInput: secondLevelResolvedInput } =
    ...
    const { resolvedInput: firstLevelResolvedInput } =
      await variableService.resolve({
  ...
  it('Test minLength and maxLength validators', async () => {
    ...
    expect(errors).toEqual({
      ...
      text2: [
        'The value: short1234678923145678 must be less than 10 characters',
      ],
    });
  });
